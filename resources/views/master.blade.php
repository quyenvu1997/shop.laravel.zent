									...
									<div class="shopping-cart-list">
										<div class="product product-widget">
											<div class="product-thumb">
												<img src="{{ asset('user/img/thumb-product01.jpg')}}" alt="">
											</div>
								...
								<div class="row hidden-sm hidden-xs">
									<div class="col-md-12">
										...
										<a class="banner banner-1" href="#">
											<img src="{{ asset('user/img/banner05.jpg')}}" alt="">
								...
								<div class="row">
									...
									<div class="col-md-4 hidden-sm hidden-xs">
										<a class="banner banner-2" href="#">
											<img src="{{ asset('user/img/banner04.jpg')}}" alt="">
								...
								<div class="row">
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="{{ asset('user/img/banner06.jpg')}}" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="{{ asset('user/img/banner07.jpg')}}" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="{{ asset('user/img/banner08.jpg')}}" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="{{ asset('user/img/banner09.jpg')}}" alt="">
												<div class="banner-caption text-center">
